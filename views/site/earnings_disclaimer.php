...
<table width="1100" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td height="70" align="center" style="color:#111; font-size:24px"><strong><?= Yii::$app->params['domain_name']; ?> Earnings Disclaimer</strong></td>
    </tr>
    <tr>
        <td align="center">&nbsp;</td>
    </tr>
    <tr>
        <td align="left">
            ...
            <p><br />
                As always, the advice of a competent legal, tax, accounting or other professional should be sought. The author and publisher do not warrant the performance, effectiveness or applicability of any sites listed or linked to in this <?= Yii::$app->params['domain_name']; ?>.
            </p>
            <p><br />
            ...
            <p><br />
                Personal Information we collect and how it is used: Service provider: when you purchase <?= Yii::$app->params['company_name']; ?>, the payment is processed by Clicksure.com, who will collect your name, address, and credit card information so as to verify your order. They may not use the information for any other purpose. Upon ordering, we also collect your name and e-mail address. We use this information to follow-up on you as per the above newsletter section.
            </p>
            ...
            <p><br />
                Results vary, and as with any money-making opportunity, you could make zero money and maybe lose money. The typical result of <?= Yii::$app->params['company_name']; ?> is zero simply because we have no idea what you would do with this information. Success in ANY money-making opportunity is a result of hard work, time and a variety of other factors. Any express or implied guarantees of income made by <?= Yii::$app->params['company_name']; ?> are fictional. The marketing video and other materials are for entertainment purposes only. Actors, props (such as cars, houses, boats and other lavish props) were rented for the purposes of creating this promotional video. The testimonials in <?= Yii::$app->params['company_name']; ?> are actors to portray what the system might achieve. Please do your research and consult the proper experts before making any decision that could impact your financial situation. <?= Yii::$app->params['company_name']; ?> is not responsible for any of your actions.
            </p>
            <p><br />
