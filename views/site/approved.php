            ...
            <div class="row">
                <div class="col-md-7 left_block">
                    <div class="embed-responsive embed-responsive-16by9">
                        <iframe id="vim-video-top" class="embed-responsive-item" src="https://player.vimeo.com/video/189312811" width="auto" height="auto"
...
<section class="last-chace-register" id="bottom-form">
    <div class="container">
        <div class="row qick-and-easy">
            ...
            <div class="container">
                <div class="gaff middle-form" id="gaff2">
<!--                    <input id="brokerName" type="hidden" value="brokenName">-->
